...
public class C24DragAndDrop extends TestBase {
    /*
    ...
    void test() {
        ...
        action
                ...
                .pause(1000)
                .dragAndDrop(fiveThousand1,debitAmount)//Drag and drop the 5000 button to the Amount section in DEBIT SIDE
                .pause(1000)
                .dragAndDrop(fiveThousand2,creditAmount)//Drag and drop the second 5000 button to the Amount section in CREDIT SIDE
                .perform();
