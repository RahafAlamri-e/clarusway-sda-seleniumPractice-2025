...
public class C40ReadExcellFile {
    /*
    ...
    */
    ...
    public void readExcelTest() throws IOException {
        ...
        int numOfUsedRows = sheet.getPhysicalNumberOfRows(); // Returns nÄ±mber of used rows //
        ...
        // Assert Canada is one of the countries
    ...
    void test02(){
        ...
        try {
            fis = new FileInputStream(Path.of(".","resources","Countries.xlsx").toString());
        ...
        // Go to 3rd row and print 2nd cell
        String r3c2Str = getCellData1(sheet,3,2);
        System.out.println("r3c2Str = " + r3c2Str);
    ...
    private String getCellData1(Sheet sheet, int row, int cell) {
        return sheet.getRow(row-1).getCell(cell-1).toString();
    }
